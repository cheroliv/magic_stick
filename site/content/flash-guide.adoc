...
L'ISO est disponible sur deux plateformes :

[cols="1,2,1"]
|===
| Plateforme | Lien | Format

| GitHub Releases
| https://github.com/cheroliv/magic_stick/releases/tag/v0.1.0[cheroliv/magic_stick v0.1.0]
| `.xz` (compressee)
...
[NOTE]
====
Si vous telechargez la version `.xz` depuis GitHub Releases, vous devez la decompresser avant le flashage :
...
Si vous telechargez l'ISO brute depuis SourceForge, elle est prete a flasher directement.
====
...
Comparez le resultat avec le fichier `.sha256` fourni sur SourceForge ou GitHub Releases.
